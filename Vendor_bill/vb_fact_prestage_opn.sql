...
FROM dw_prestage.vb_fact_insert A
  ...
  INNER JOIN DW.DWDATE H ON (NVL (TO_CHAR (A.VB_DUE_DATE,'YYYYMMDD'),'0') = H.DATE_ID)
  INNER JOIN DW.DWDATE I ON (NVL (TO_CHAR (A.GL_POST_DATE,'YYYYMMDD'),'0') = I.DATE_ID)  
  INNER JOIN DW.DWDATE T ON (NVL (TO_CHAR (A.VENDOR_BILL_DATE,'YYYYMMDD'),'0') = T.DATE_ID) 
  INNER JOIN DW.DWDATE U ON (NVL (TO_CHAR (A.CLOSE_DATE,'YYYYMMDD'),'0') = U.DATE_ID) 
...
FROM dw_prestage.vb_fact_insert A
  ...
  LEFT OUTER JOIN DW.DWDATE H ON (NVL (TO_CHAR (A.VB_DUE_DATE,'YYYYMMDD'),'0') = H.DATE_ID)
  LEFT OUTER JOIN DW.DWDATE I ON (NVL (TO_CHAR (A.GL_POST_DATE,'YYYYMMDD'),'0') = I.DATE_ID)  
  LEFT OUTER JOIN DW.DWDATE T ON (NVL (TO_CHAR (A.VENDOR_BILL_DATE,'YYYYMMDD'),'0') = T.DATE_ID) 
  LEFT OUTER JOIN DW.DWDATE U ON (NVL (TO_CHAR (A.CLOSE_DATE,'YYYYMMDD'),'0') = U.DATE_ID) 
  LEFT OUTER JOIN DW.EMPLOYEES C ON (NVL (A.REQUESTOR_ID,-99) = C.EMPLOYEE_ID)  
  LEFT OUTER JOIN DW.EMPLOYEES D ON (NVL (A.APPROVER_LEVEL_ONE_ID,-99) = D.EMPLOYEE_ID)  
  LEFT OUTER JOIN DW.EMPLOYEES D1 ON (NVL (A.APPROVER_LEVEL_TWO_ID,-99) = D1.EMPLOYEE_ID)   
  ...
  LEFT OUTER JOIN DW.PAYMENT_TERMS P ON (NVL (A.PAYMENT_TERMS_ID,-99) = P.PAYMENT_TERMS_ID)
