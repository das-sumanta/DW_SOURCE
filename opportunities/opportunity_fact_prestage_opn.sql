...
FROM dw_prestage.opportunity_fact_insert A
  ...
  LEFT OUTER JOIN DW_REPORT.BOOK_FAIRS E
          ON (A.ABCDO_MARKER_ID = E.MARKER_ID
         AND A.BOOK_FAIRS_STATUS_ID = E.FAIR_STATUS_ID
         AND A.BOOK_FAIR_TYPE_ID = E.FAIR_TYPE_ID
         AND A.TRUCK_ROUTE_ID = E.ROUTE_ID
         AND A.INVOICE_OPTION_ID = E.INVOICE_OPTION_ID)
