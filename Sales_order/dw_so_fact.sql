...
DROP TABLE if exists dw.so_fact;

CREATE TABLE dw.so_fact 
(
  SO_KEY				      BIGINT IDENTITY(0,1),
  ...
  DOCUMENT_STATUS_KEY         VARCHAR(500),
  DOCUMENT_TYPE_KEY           VARCHAR(200),
  ...
  FOREIGN KEY(DOCUMENT_TYPE_KEY) REFERENCES DW.TRANSACTION_TYPE (TRANSACTION_TYPE_KEY ),
  ...
  FOREIGN KEY(TEACHER_KEY) REFERENCES DW.VENDORS (VENDOR_KEY ), 
  FOREIGN KEY(BOOK_FAIRS_CONSULTANT_KEY) REFERENCES DW.EMPLOYEES (EMPLOYEE_KEY ),
  FOREIGN KEY(PREPACK_KEY) REFERENCES DW.ITEMS (ITEM_KEY),  
