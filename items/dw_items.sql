...
(
  ...
  EXPENSE_ACCOUNT_NUMBER               VARCHAR(100),
  ...
  VENDRETURN_VARIANCE_ACCOUNT_NUMBER   VARCHAR(100),
...
SELECT -99 AS ITEM_ID,
       ...
       -99 AS PRODUCT_CALSSIFICATION_ANZ_ID,
       -99 AS PRODUCT_CATEGORY_ID,
       -99 AS PRODUCT_TYPE_ANZ_ID,
       -99 AS PUBLISHER_ID,
       'NA_GDW' AS PURCHASEDESCRIPTION,
       'NA_GDW' AS SALESDESCRIPTION,
...
SELECT 0 AS ITEM_ID,
       ...
       0 AS PRODUCT_CALSSIFICATION_ANZ_ID,
       0 AS PRODUCT_CATEGORY_ID,
       0 AS PRODUCT_TYPE_ANZ_ID,
       0 AS PUBLISHER_ID,
       'NA_ERR' AS PURCHASEDESCRIPTION,
       'NA_ERR' AS SALESDESCRIPTION,
