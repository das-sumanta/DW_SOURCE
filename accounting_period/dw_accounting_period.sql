...
(
  ...
  DW_ACTIVE               VARCHAR(1),
  PRIMARY KEY (ACCOUNTING_PERIOD_KEY,ACCOUNTING_PERIOD_ID,PERIOD_NAME)
)
DISTSTYLE ALL INTERLEAVED SORTKEY (ACCOUNTING_PERIOD_KEY,ACCOUNTING_PERIOD_ID,PERIOD_NAME,DW_ACTIVE);
