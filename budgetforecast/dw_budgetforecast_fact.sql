...
DISTKEY(FISCAL_WEEK_ID) ALL INTERLEAVED SORTKEY (SUBSIDIARY_KEY,BUDGETFORECAST_TYPE,BUDGETFORECAST_ID,BUDGETFORECAST_NAME,FISCAL_MONTH_ID,FISCAL_WEEK_ID);
