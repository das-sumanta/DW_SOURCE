...
(
  ...
  PRIMARY KEY (BUDGETFORECAST_ERROR_KEY,BUDGETFORECAST_TYPE,BUDGETFORECAST_ID,BUDGETFORECAST_NAME,FISCAL_MONTH_ID,FISCAL_WEEK_ID)
)
DISTSTYLE ALL INTERLEAVED SORTKEY (BUDGETFORECAST_ERROR_KEY,BUDGETFORECAST_TYPE,BUDGETFORECAST_ID,BUDGETFORECAST_NAME,FISCAL_MONTH_ID,FISCAL_WEEK_ID);
