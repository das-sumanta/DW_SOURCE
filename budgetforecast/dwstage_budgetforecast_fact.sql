...
DISTKEY(FISCAL_WEEK_ID) ALL INTERLEAVED SORTKEY (RUNID,SUBSIDIARY_ID,BUDGETFORECAST_TYPE,BUDGETFORECAST_ID,BUDGETFORECAST_NAME,FISCAL_MONTH_ID,FISCAL_WEEK_ID);
