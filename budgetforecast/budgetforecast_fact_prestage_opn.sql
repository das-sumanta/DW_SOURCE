...
SELECT A.RUNID,
       ...
       CASE
         ...
         WHEN (B.CLASS_KEY IS NULL AND A.LINE_OF_BUSINESS_ID IS NULL) THEN ' NO MANDATORY DIM FROM SOURCE FAILED '
         ELSE 'OK'
       END,
       C.TERRITORY_KEY,
       ...
       CASE
         ...
         WHEN (C.TERRITORY_KEY IS NULL AND A.REGIONSALES_TERRITORY_ID IS NULL) THEN ' NO MANDATORY DIM FROM SOURCE FAILED '
         ELSE 'OK'
       END,
       D.SUBSIDIARY_KEY,
       A.SUBSIDIARY_ID,
       CASE
         ...
         WHEN (D.SUBSIDIARY_KEY IS NULL AND A.SUBSIDIARY_ID IS NULL) THEN ' NO MANDATORY DIM FROM SOURCE FAILED '
         ELSE 'OK'
       END,
       BUDGETFORECAST_TYPE,
       MONTH_END_DATE,
