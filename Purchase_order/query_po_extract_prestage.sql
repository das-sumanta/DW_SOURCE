SELECT
       ...
       F.TRANSACTION_NUMBER AS REF_TRX_NUMBER,  /* ADDD */
       F.TRANSACTION_TYPE AS REF_TRX_TYPE,      /* ADDD */
       ...
       /* header level amount */ REPLACE(REPLACE(TRANSACTIONS.APPROVAL_STATUS,CHR (10),' '),CHR (13),' ') AS APPROVAL_STATUS,
       /*   REPLACE(REPLACE(TRANSACTIONS.BILLADDRESS,CHR (10),' '),CHR (13),' ') AS BILLADDRESS,  */ e.bill_address_line_1,
       ...
       e.bill_state,
       e.bill_zip,
 /*    REPLACE(REPLACE(TRANSACTIONS.CARRIER,CHR (10),' '),CHR (13),' ') AS CARRIER, */ /* REMOVED */
 /*    REPLACE(REPLACE(TRANSACTIONS.CARRIER_ADDRESS,CHR (10),' '),CHR (13),' ') AS CARRIER_ADDRESS, */ /* REMOVED */
       TO_CHAR(TRANSACTIONS.CARRIER_LEBEL_ID) AS CARRIER_ID,  /* MODIFIED */
       ...
       /*  REPLACE(REPLACE(TRANSACTIONS.SHIPADDRESS,CHR (10),' '),CHR (13),' ') AS SHIPADDRESS, */ e.ship_address_line_1,
...
AND   (TRANSACTION_LINES.DATE_LAST_MODIFIED >= '1900-01-01 00:00:00' OR TRANSACTIONS.DATE_LAST_MODIFIED >= '1900-01-01 00:00:00')
