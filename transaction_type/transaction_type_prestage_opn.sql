...
(SELECT TRANSACTION_TYPE_ID FROM DW_PRESTAGE.TRANSACTION_TYPE
MINUS
SELECT TRANSACTION_TYPE_ID FROM DW_STAGE.TRANSACTION_TYPE )) A
WHERE  DW_PRESTAGE.TRANSACTION_TYPE.TRANSACTION_TYPE_ID = A.TRANSACTION_TYPE_ID );
