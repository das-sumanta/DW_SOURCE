...
(
  ...
  DW_CURRENT                  INTEGER,
  PRIMARY KEY (REVENUE_KEY,TRANSACTION_DATE_KEY,SUBSIDIARY_KEY,DOCUMENT_TYPE_KEY,DOCUMENT_NUMBER)
)
DISTKEY(ITEM_KEY) INTERLEAVED SORTKEY (TRANSACTION_DATE_KEY,SUBSIDIARY_KEY,DOCUMENT_TYPE_KEY,DOCUMENT_NUMBER);  
