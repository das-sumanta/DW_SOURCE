...
,A.QUANTITY
 ...
 ,NVL(A.prepack_key,s.item_key) prepack_key
 ,NVL(A.product_catalogue_key,t.product_catalogue_key) product_catalogue_key
 ,A.PRICE_TYPE
...
AND A.transaction_type IN ('Credit Memo','Return Authorization','Invoice')
UNION ALL
SELECT
  A.RUNID
, A.DOCUMENT_NUMBER
...
WHERE A.RUNID = NVL(RUNID_ERR,A.RUNID)
AND A.RECORD_STATUS = 'ERROR'
AND A.transaction_type IN ('Journal');
