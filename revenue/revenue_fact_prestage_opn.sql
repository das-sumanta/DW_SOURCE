...
, A.ITEM_ID
   ,CASE
         ...
         WHEN (g.item_key IS NULL AND A.ITEM_ID IS NULL AND trx_type in ('INV_LINE','RA_LINE','CN_LINE' )) THEN ' NO MANDATORY DIM FROM SOURCE FAILED '
         ELSE 'OK'
       END
, A.TAX_ITEM_ID
   ,CASE
...
,A.CUSTOMER_ID
   ,CASE
         ...
         WHEN (m.customer_key IS NULL AND A.CUSTOMER_ID IS NULL AND trx_type in ('INV_LINE','RA_LINE','CN_LINE' )) THEN ' NO MANDATORY DIM FROM SOURCE FAILED '
         ELSE 'OK'
       END
